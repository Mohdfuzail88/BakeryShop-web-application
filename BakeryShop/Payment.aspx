...
<div class="form-group">
<asp:Label ID="Label5" runat="server" CssClass="control-label" Text="Choose Payment Mode"></asp:Label>
...
<asp:Button ID="COD" CssClass=" btn btn-info" Font-Size="Large" ValidationGroup="PaymentPage" runat="server" OnClick="COD_Click" Text="Checkout &raquo;" />
</div>                               
</div>
</div>
</div>
