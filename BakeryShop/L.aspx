<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="L.aspx.cs" Inherits="L" %>
...
<div action="" id="formvalidate" runat="server">
...
<asp:Button ID="Button1" type="submit"  runat="server"  Class="form-control" Text="Login" OnClick="Button1_Click" Style="background:#337ab7;  color: #fff;"/>
<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
<div class="clearfix supporter">
<div class="pull-left remember-me">
<asp:CheckBox ID="CheckBox1" runat="server" />
<asp:Label ID="Label" CssClass =" control-label " runat="server" Text="Remember me"></asp:Label>
</div>
<a class="forgot pull-right" href="ForgotPassword.aspx">Forgot Password?</a>
</div>        
</div>
</div>
<div class="signup-wrapper text-center">
<a href="R.aspx">"Don't have an accout? <span class="text-primary">Create One</span></a>
</div>
</div>
<footer>
<div class ="alert alert-danger ">           
<p class ="pull-right "><a href="Admin/AdminLogins.aspx" style="font-size:medium;"> Admin Login  </a></p> 
<p>&copy;2023 MFBakery.in   </p>
</div>
</footer>
</asp:Content>
