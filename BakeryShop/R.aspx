<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="R.aspx.cs" Inherits="R" %>
...
<div class="input-group">
<asp:TextBox ID="txtCPass" runat="server" placeholder="Confirm password" CssClass="form-control" TextMode="Password"></asp:TextBox>           
</div>
<asp:Button ID="Button1" type="submit"  runat="server"  Class="form-control" Text="Register" Onclick="Button1_Click" Style="background:#337ab7;  color: #fff;" />       
<asp:Label ID="LabelRegistration" runat="server" ></asp:Label>
</div>
</div>
<div class="signup-wrapper text-center">
<a href="L.aspx">Already Have account <span class="text-primary">Login</span></a>
</div>
</div>
</asp:Content>
